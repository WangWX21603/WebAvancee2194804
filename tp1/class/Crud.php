...
class Crud extends PDO{
    ...
    public function __construct(){
        parent::__construct("mysql:host=localhost;dbname=e2194804;charse=utf8", "e2194804", "UCwUsEdDa5DPaaai6aEK");
    }
    ...
    public function insert($table, $data){
        ...
        if(!$query->execute()){
            ...
            echo "Tu as créé cet article avec success!";
        }
    }
    ...
    public function delete($table, $id, $url){
        ...
        if(!$query->execute()){
            ...
            echo "Tu as supprimé cet article avec success!";
            //header("Location: $url");
        }
    }
    ...
    public function update($table, $data, $champ, $id){
        ...
        if(!$query->execute()){
            ...
            echo "Tu as modifié cet article avec success!";
        }
    }
