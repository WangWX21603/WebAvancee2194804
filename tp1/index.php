...
<body>
    ...
    <div class="page-container">
        ...
        <main class="wrapper">
            ...
            <div class="article">
                <div class="title-wrapper">
                    ...
                    <div class="button-wrapper">
                        <form action="article-modification.php?id=<?php echo $row["id"];?>" method="post">
                            <input type="hidden" value="<?php echo $row["id"]; ?>" name="id">
                            <input type="submit" value="Modifier cet article">
                        </form>

                        <form action="article-suppression.php" method="post">
                            <input type="hidden" value="<?php echo $row["id"]; ?>" name="id">
            ...
            <a href="article-creation.php" class="btn-a">Créer un article</a>
