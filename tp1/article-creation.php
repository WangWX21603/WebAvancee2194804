...
<body >
    ...
    <main>
        <div class="wrapper">
            ...
            <form method="POST" action="article-post.php" class="form-article wrapper">
                Titre: <input type="text" name="titre" class="titre"/><br>
                

                Texte : <textarea type="text" name="texte" rows="30" cols="100" class="text"></textarea>
