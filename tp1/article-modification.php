...
$crud = new Crud;
$client = $crud->selectId("article", "id", $_GET["id"]);
...
<head>
    ...
    <title>Article Modificaiton</title>
...
<body>
    ...
    <div  class="wrapper">
        ...
        <form method="POST" action="article-modification-post.php" class="form-article wrapper">
            <input type="hidden" value="<?php echo $id; ?>" name="id">
            Titre: <input type="text" name="titre" class="titre" value="<?php echo $titre; ?>"/><br>
            

            Texte : <textarea type="text" name="texte" rows="30" cols="100" class="text"><?php echo $texte; ?></textarea>
